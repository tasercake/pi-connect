...
func daemonInstall(args []string) {
	...
	fmt.Println("pi-connect daemon installed and started.")
	fmt.Println()
	...
	fmt.Println("  pi-connect daemon status    - Check status")
	fmt.Println("  pi-connect daemon logs -f   - Follow logs")
	fmt.Println("  pi-connect daemon restart   - Restart")
	fmt.Println("  pi-connect daemon stop      - Stop")
	fmt.Println("  pi-connect daemon uninstall - Remove")
}
...
func daemonUninstall() {
	...
	daemon.RemoveMeta()
	fmt.Println("pi-connect daemon uninstalled.")
}
...
func daemonStart() {
	...
	fmt.Println("pi-connect daemon started.")
}
...
func daemonStop() {
	...
	fmt.Println("pi-connect daemon stopped.")
}
...
func daemonRestart(args []string) {
	...
	fmt.Println("pi-connect daemon restarted.")
}
...
func requireInstalled(mgr daemon.Manager) {
	...
	if st == nil || !st.Installed {
		...
		fmt.Fprintln(os.Stderr, "  pi-connect daemon install --work-dir /path/to/config-dir")
		os.Exit(1)
	}
}
...
func daemonStatus() {
	...
	fmt.Println("pi-connect daemon status")
	fmt.Println()
	...
	if !st.Installed {
		...
		fmt.Printf("  Platform:  %s\n", st.Platform)
		fmt.Println()
		fmt.Println("  Run: pi-connect daemon install")
		return
	}
...
func printDaemonUsage() {
	fmt.Println(`Usage: pi-connect daemon <command> [flags]
...
Install flags:
  ...
  --log-file PATH       Log file path (default: ~/.pi-connect/logs/pi-connect.log)
