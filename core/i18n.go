...
var messages = map[MsgKey]map[Language]string{
	...
	MsgForumTopicAttachmentFailed: {
		LangEnglish:            "Could not download the attachment. Please resend it.",
		LangChinese:            "无法下载附件。请重新发送。",
	...
	MsgAgentTemporarilyUnavailable: {
		LangEnglish:            "⚠️ The agent hit a temporary upstream timeout. Please try again in a moment.",
		LangChinese:            "⚠️ Agent 遇到临时上游超时。请稍后重试。",
	...
	MsgUnknownCommand: {
		LangEnglish:            "`%s` is not a pi-connect command, forwarding to agent...",
		LangChinese:            "`%s` 不是 pi-connect 命令，已转发给 Agent 处理...",
		LangTraditionalChinese: "`%s` 不是 pi-connect 命令，已轉發給 Agent 處理...",
		LangJapanese:           "`%s` は pi-connect のコマンドではありません。エージェントに転送します...",
		LangSpanish:            "`%s` no es un comando de pi-connect, reenviando al agente...",
	},
	MsgWelcome: {
		LangEnglish:            "👋 Hi! I'm pi-connect, bridging you to **%s**.\n\nJust send a message to chat with the agent. Type /help to see built-in commands.",
		LangChinese:            "👋 你好！我是 pi-connect，已为你连接到 **%s**。\n\n直接发送消息即可与 Agent 对话。输入 /help 查看内置命令。",
		LangTraditionalChinese: "👋 你好！我是 pi-connect，已為你連接到 **%s**。\n\n直接發送訊息即可與 Agent 對話。輸入 /help 查看內建命令。",
		LangJapanese:           "👋 こんにちは！pi-connect が **%s** に接続しました。\n\nメッセージを送信すればエージェントと会話できます。/help で組み込みコマンド一覧を確認できます。",
		LangSpanish:            "👋 ¡Hola! Soy pi-connect, conectándote con **%s**.\n\nEnvía un mensaje para chatear con el agente. Usa /help para ver los comandos integrados.",
	},
	MsgHelp: {
		LangEnglish: "📖 Available Commands\n\n" +
			...
			"/restart\n  Restart pi-connect service\n\n" +
			"/status\n  Show system status\n\n" +
			"/version\n  Show pi-connect version\n\n" +
		...
		LangSpanish: "📖 Comandos disponibles\n\n" +
			...
			"/restart\n  Reiniciar el servicio pi-connect\n\n" +
			"/status\n  Mostrar estado del sistema\n\n" +
			"/version\n  Mostrar versión de pi-connect\n\n" +
	...
	MsgHelpTitle: {
		LangEnglish:            "pi-connect Help",
		LangChinese:            "pi-connect 帮助",
		LangTraditionalChinese: "pi-connect 說明",
		LangJapanese:           "pi-connect ヘルプ",
		LangSpanish:            "pi-connect Ayuda",
	},
	...
	MsgProviderListEmpty: {
		...
		LangJapanese:           "プロバイダが設定されていません。\n\n`config.toml` または `pi-connect provider add` で追加してください。",
	...
	MsgStatusTitle: {
		...
		LangChinese: "pi-connect 状态\n\n" +
			...
			"语言: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangTraditionalChinese: "pi-connect 狀態\n\n" +
			"項目: %s\n" +
			"Agent: %s\n" +
			"工作目錄: %s\n" +
			"平台: %s\n" +
		...
		LangJapanese: "pi-connect ステータス\n\n" +
			...
			"言語: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangSpanish: "Estado de pi-connect\n\n" +
			"Proyecto: %s\n" +
			"Agente: %s\n" +
			"Directorio: %s\n" +
			"Plataformas: %s\n" +
	...
	MsgCardTitleStatus: {
		LangEnglish: "pi-connect Status", LangChinese: "pi-connect 状态", LangTraditionalChinese: "pi-connect 狀態",
		LangJapanese: "pi-connect ステータス", LangSpanish: "Estado de pi-connect",
	},
	...
	MsgRestarting: {
		LangEnglish:            "🔄 Restarting pi-connect...",
		LangChinese:            "🔄 正在重启 pi-connect...",
		LangTraditionalChinese: "🔄 正在重啟 pi-connect...",
		LangJapanese:           "🔄 pi-connect を再起動中...",
		LangSpanish:            "🔄 Reiniciando pi-connect...",
	},
	MsgRestartSuccess: {
		LangEnglish:            "✅ pi-connect restarted successfully.",
		LangChinese:            "✅ pi-connect 重启成功。",
		LangTraditionalChinese: "✅ pi-connect 重啟成功。",
		LangJapanese:           "✅ pi-connect の再起動が完了しました。",
		LangSpanish:            "✅ pi-connect se reinició correctamente.",
	},
	MsgUpgradeChecking: {
	...
	MsgRelaySetupHint: {
		LangEnglish:            "\n\n⚠️ This agent does not auto-inject pi-connect instructions.\nPlease run `/bind setup` or `/cron setup` to write instructions to %s.",
		LangChinese:            "\n\n⚠️ 当前 agent 不会自动注入 pi-connect 指令。\n请运行 `/bind setup` 或 `/cron setup` 将指令写入 %s。",
		LangTraditionalChinese: "\n\n⚠️ 當前 agent 不會自動注入 pi-connect 指令。\n請執行 `/bind setup` 或 `/cron setup` 將指令寫入 %s。",
		LangJapanese:           "\n\n⚠️ このエージェントは pi-connect の指示を自動注入しません。\n`/bind setup` または `/cron setup` を実行して %s に指示を書き込んでください。",
		LangSpanish:            "\n\n⚠️ Este agente no inyecta automáticamente las instrucciones de pi-connect.\nEjecute `/bind setup` o `/cron setup` para escribirlas en %s.",
	},
	MsgRelaySetupOK: {
		LangEnglish:            "✅ pi-connect instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ pi-connect 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
		LangTraditionalChinese: "✅ pi-connect 指令已寫入 %s\nagent 現在可以使用中繼、定時任務和附件回傳功能了。",
		LangJapanese:           "✅ pi-connect の指示を %s に書き込みました。\nエージェントがリレー、cron、添付ファイル返送を使えるようになりました。",
		LangSpanish:            "✅ Instrucciones de pi-connect escritas en %s\nEl agente ahora puede usar relay, cron y reenvío de adjuntos.",
	},
	MsgRelaySetupExists: {
		LangEnglish:            "ℹ️ pi-connect instructions already exist in %s — no changes made.",
		LangChinese:            "ℹ️ pi-connect 指令已存在于 %s 中，无需重复写入。",
		LangTraditionalChinese: "ℹ️ pi-connect 指令已存在於 %s 中，無需重複寫入。",
		LangJapanese:           "ℹ️ pi-connect の指示は既に %s に存在します。変更はありません。",
		LangSpanish:            "ℹ️ Las instrucciones de pi-connect ya existen en %s — sin cambios.",
	},
	...
	MsgSetupNative: {
		LangEnglish:            "✅ This agent natively supports pi-connect instructions — no setup needed.",
		LangChinese:            "✅ 当前 agent 已原生支持 pi-connect 指令，无需额外配置。",
		LangTraditionalChinese: "✅ 當前 agent 已原生支持 pi-connect 指令，無需額外配置。",
		LangJapanese:           "✅ このエージェントは pi-connect の指示をネイティブサポートしています。セットアップ不要です。",
		LangSpanish:            "✅ Este agente soporta nativamente las instrucciones de pi-connect — no se necesita configuración.",
	},
	MsgCronSetupOK: {
		LangEnglish:            "✅ pi-connect instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ pi-connect 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
	...
	MsgBuiltinCmdRestart: {
		LangEnglish:            "Restart pi-connect service",
		LangChinese:            "重启 pi-connect 服务",
		LangTraditionalChinese: "重啟 pi-connect 服務",
		LangJapanese:           "pi-connect サービスを再起動",
		LangSpanish:            "Reiniciar el servicio pi-connect",
	},
	MsgBuiltinCmdStatus: {
	...
	MsgBuiltinCmdVersion: {
		LangEnglish:            "Show pi-connect version",
		LangChinese:            "查看 pi-connect 版本",
		LangTraditionalChinese: "查看 pi-connect 版本",
		LangJapanese:           "pi-connect のバージョンを表示",
		LangSpanish:            "Mostrar versión de pi-connect",
	},
	MsgBuiltinCmdHelp: {
